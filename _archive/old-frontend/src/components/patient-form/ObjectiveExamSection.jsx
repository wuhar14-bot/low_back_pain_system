                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t">
                  {formData.ai_posture_analysis.annotatedStandingUrl && (
                    <div className="space-y-2">
                      ...
                      <img src={formData.ai_posture_analysis.annotatedStandingUrl} alt="站立位姿态分析" className="rounded-lg border bg-slate-100" />
                    </div>
                  )}
                  {formData.ai_posture_analysis.annotatedFlexionUrl && (
                    <div className="space-y-2">
                       <p className="font-medium text-sm text-center text-slate-700">屈曲位姿态分析</p>
                      <img src={formData.ai_posture_analysis.annotatedFlexionUrl} alt="屈曲位姿态分析" className="rounded-lg border bg-slate-100" />
                    </div>
                  )}
                </div>
              )}
