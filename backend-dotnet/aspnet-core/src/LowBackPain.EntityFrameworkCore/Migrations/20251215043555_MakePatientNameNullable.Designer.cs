...
{
    [DbContext(typeof(LowBackPainDbContext))]
    [Migration("20251215043555_MakePatientNameNullable")]
    partial class MakePatientNameNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LowBackPain.Entities.Patient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AiPostureAnalysisJson")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("FunctionalScoresJson")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("InterventionJson")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("ObjectiveExamJson")
                        .HasColumnType("jsonb");

                    b.Property<DateTime?>("OnsetDate")
                        .HasColumnType("timestamp without time zone");

                    b.Property<string>("PainAreasJson")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("SubjectiveExamJson")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("LowBackPain.Entities.PatientImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPatientImages", (string)null);
                });
            ...
            modelBuilder.Entity("LowBackPain.Entities.PatientImage", b =>
                {
                    b.HasOne("LowBackPain.Entities.Patient", "Patient")
                        .WithMany("Images")
